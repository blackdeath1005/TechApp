...
namespace Tech.Interfaces
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/accordionMenu").Include(
            "~/Scripts/accordionmenu.js"));
            bundles.Add(new ScriptBundle("~/bundles/datepicker").Include(
            "~/Scripts/bootstrap-datepicker.js"));
            bundles.Add(new ScriptBundle("~/bundles/datetimepicker").Include(
            "~/Scripts/bootstrap-datetimepicker.js"));
            bundles.Add(new ScriptBundle("~/bundles/dhtmlxcalendar").Include(
            ...
            bundles.Add(new StyleBundle("~/Content/dhtmlxcalendar").Include("~/Content/dhtmlxcalendar.css"));
