...
<h2>Consultar Casos de Servicio</h2>

<% using (Html.BeginForm("SearchCaso", "CasoServicio", FormMethod.Post, new { @class = "form-horizontal" })) { %>
    ...
    <div class="form-group">
      ...
      <div class="col-md-2">
        <%: Html.DropDownList("estado", new SelectList( new List<string>{"Asignado","Pendiente Asignacion","Terminado"} ), "-------Seleccione-------", new { @class = "form-control input-md" }) %>
      </div>
    </div>
...
<% } %>
    ...
    <div class="container">
        ...
        <div id="searchForm">
            <%: Html.Action("IndexCaso","CasoServicio") %>
        </div>
    </div>
