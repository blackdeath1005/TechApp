                    ...
                    <td class="vert-align"><ul class="nav nav-pills">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="<%:Url.Action("DetailsSolicitud", "CasoServicio", new { id=item.Co_Solicitud }) %>" data-toggle="modal" data-target="#DetailModal">
                                        <span class="glyphicon glyphicon-file"></span>
                                        Ver
                                    </a>
                                    <a href="<%:Url.Action("Create", "CasoServicio", new { codSolicitud=item.Co_Solicitud }) %>">
