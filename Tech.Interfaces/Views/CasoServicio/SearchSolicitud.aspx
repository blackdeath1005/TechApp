...
<% using (Html.BeginForm("SearchSolicitud", "CasoServicio", FormMethod.Post, new { @class = "form-horizontal" })) { %>
...
<% } %>
    ...
    <div class="form-group">
      ...
      <button class="btn btn-success" onclick="window.location='<%: Url.Action("Create", "CasoServicio") %>'"><span class="glyphicon glyphicon-pencil"></span> Nuevo Caso</button>
    </div>

    <div class="container">
        <div id="searchFormResult"> </div>
        <div id="searchForm">
            <%: Html.Action("IndexSolicitud","CasoServicio") %>
        </div>
    </div>
